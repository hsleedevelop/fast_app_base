...
class NotificationItemWidget extends StatefulWidget {
  ...
  const NotificationItemWidget({required this.onTap, super.key, required this
      .notification});
  ...
  Widget build(BuildContext context) {
    return Tap(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
                ...
                emptyExpanded,
                timeago
                    .format(widget.notification.time, locale: context.locale
                    .languageCode)
                    .text
                    .size(13)
                    .color(context.appColors.lessImportant)
        ...
        widget.notification.description.text.make().pOnly(left: 35)
        ],
      ),),
    );
  }
